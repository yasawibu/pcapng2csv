...
SET tshark_cmd=-Y "%filter%" -T fields -E separator=, -E quote=d -e frame.number -e frame.time_relative -e frame.time_delta_displayed -e _ws.col.Source -e _ws.col.Destination -e _ws.col.Protocol -e frame.len -e _ws.col.Info
